...
impl ShortcutRegistry {
    ...
    pub fn match_editor_view_shortcut(&self, event: &KeyEvent) -> Option<EditorViewAction> {
        ...
        match event.code {
            ...
            KeyCode::Char('e') => Some(EditorViewAction::WordEndForward),
            KeyCode::Char('W') => Some(EditorViewAction::WordForwardWhitespace),
            KeyCode::Char('B') => Some(EditorViewAction::WordBackWhitespace),
            KeyCode::Home | KeyCode::Char('0') => Some(EditorViewAction::LineHead),
            KeyCode::Char('^') => Some(EditorViewAction::LineFirstNonBlank),
            KeyCode::Char('+') => Some(EditorViewAction::NextLineFirstNonBlank),
            KeyCode::Char('-') => Some(EditorViewAction::PrevLineFirstNonBlank),
            KeyCode::Char('%') => Some(EditorViewAction::MatchBrace),
            ...
            KeyCode::Char('i') | KeyCode::Enter => Some(EditorViewAction::EnterInsert),
            ...
            KeyCode::Char('r') => Some(EditorViewAction::ReplaceChar),
            KeyCode::Char('J') => Some(EditorViewAction::JoinLines),
            KeyCode::Char('f') => Some(EditorViewAction::FindCharForward),
            KeyCode::Char('F') => Some(EditorViewAction::FindCharBackward),
            KeyCode::Char('t') => Some(EditorViewAction::TillCharForward),
            KeyCode::Char('T') => Some(EditorViewAction::TillCharBackward),
            KeyCode::Char(';') => Some(EditorViewAction::RepeatFind),
            KeyCode::Char(',') => Some(EditorViewAction::RepeatFindReverse),
            KeyCode::Char('D') => Some(EditorViewAction::DeleteToEnd),
            KeyCode::Char('C') => Some(EditorViewAction::ChangeToEnd),
            KeyCode::Char('Y') => Some(EditorViewAction::YankLine),
    ...
    pub fn help_entries(&self) -> Vec<(&'static str, &'static str)> {
        vec![
            ...
            (
                "Ctrl+D",
                "Delete selected note from Search/List (y/n prompt)",
            ),
            ...
            ("f, F, t, T", "Find/till character in line; ; and , repeat"),
            ("i, a, o", "Enter Insert mode"),
            ("v, V", "Enter Visual mode (char / line)"),
            ("y, yy, yNy", "Copy selection / line / N lines (+ system clipboard)"),
            ("d, dd, dNd", "Cut (delete) selection / line / N lines"),
            ("dw, diw, D", "Delete word / inner word / to end of line"),
            ("cw, ciw, cc, C", "Change word / inner word / line / to end"),
            ("yw, yiw, Y", "Yank word / inner word / whole line"),
            ("r, J", "Replace character / Join line below"),
            ("p, P", "Paste after / before cursor (system clipboard aware)"),
            ("u, Ctrl+R", "Undo / Redo (Vim mode)"),
            (
                "Ctrl+D/U, Ctrl+F",
                "Scroll half page down/up, full page down",
            ),
